...
> Рабочий процесс для контрибьюторов: принципы, окружение, стиль кода, PR и тесты.

Спасибо за интерес к Anomaly AI.
...
4. [Pull Request](#запросы-на-слияние-pull-request)
5. [Тесты](#тесты)
